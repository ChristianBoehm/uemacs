...
ifeq ($(uname_S),CYGWIN_NT-10.0-WOW)
 DEFINES=-DAUTOCONF -DPOSIX -DUSG -D_XOPEN_SOURCE=600 -D_GNU_SOURCE -DCYGWIN
endif
ifeq ($(uname_S),CYGWIN_NT-10.0)
 DEFINES=-DAUTOCONF -DPOSIX -DSYSV -D_XOPEN_SOURCE=600 -D_GNU_SOURCE -DCYGWIN
endif
#DEFINES=-DAUTOCONF
#LIBS=-ltermcap			# BSD
LIBS=-lcurses			# SYSV
